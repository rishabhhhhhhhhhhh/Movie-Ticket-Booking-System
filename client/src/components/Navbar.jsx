...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full h-20 flex items-center justify-between px-6 md:px-16 lg:px-36'>
        <Link to='/' className='max-md:flex-1'>
        <img src="/main_logo.png" alt="" className='h-20 object-contain'/>
        </Link>
        ...
        <div className='flex items-center gap-8'>
            ...
            {
                !user ? (<button onClick={openSignIn} className='px-4 py-1 sm:px-7 sm:py2 bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer'>Login</button>) :
                (<UserButton>
